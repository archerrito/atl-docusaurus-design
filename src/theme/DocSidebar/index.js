...
import SiteMenuBlock from "./siteMenu";
  ...
  return (
    <div className={clsx(styles.sidebar, {
      ...
      [styles.sidebarHidden]: isHidden
        ...
        />
        <div className={styles.siteMenu} onClick={handleShoweModal}>
          <div className={styles.siteMenuIcon}>
            <span />
            <span />
            <span />
          </div>
        ...
        [styles.menuWithAnnouncementBar]: !isAnnouncementBarClosed && scrollY === 0
          ...
          <ul className="menu__list">
            {
              sidebar.map(item =>
              <DocSidebarItem key={item.label} item={item} onItemClick={e => {
                e.target.blur();
                setShowResponsiveSidebar(false);
              }}
        ...
        { hideableSidebar &&
          <button
            ...
            styles.collapseSidebarButton)} onClick={onCollapse}
          >
